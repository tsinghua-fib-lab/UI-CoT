...
input_json_path = "/data3/maruolong/Train_Data/Add_Path/NEW_Test/gc_2000_test_calcultate_gini_value.json"  # 输入的 JSONL 文件路径
output_jsonl_path = "/data3/maruolong/Train_Data/Add_Path/small_gini_part_tract.jsonl"  # 输出的 JSONL 文件路径
output_jsonl_large_path = "/data3/maruolong/Train_Data/Add_Path/large_gini_part_tract.jsonl"  # 存储后一半较大的样本的 JSONL 文件路径
