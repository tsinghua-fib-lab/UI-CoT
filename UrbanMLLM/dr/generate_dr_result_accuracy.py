...
jsonl_file_path = "/data3/maruolong/Train_Data/Add_Path/bw_ratio/UrbanMLLM_train/dr_pretrained_5_CoT_result.jsonl"  # 替换为你的 JSONL 文件路径
